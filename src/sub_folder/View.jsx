...
const [tripView, setTripView] = useState([]);
  ...
  return (
    <div className="view_dev">
      ...
      <div>
        <img src={tripView.image} className="view_img" alt={tripView.trip_name} />
      </div>
      <div className="view-body">
        ...
        <div className="view-con2">
          <p>: {tripView.trip_name} </p>
          <p>: {updateView.city} </p>
          <p>: {updateView.str_date} </p>
          <p>: {updateView.end_date} </p>
          <p >: {updateView.route}</p>
          <p>: {updateView.budjet}/per head </p>
          ...
          <p>: {updateView.member} </p>
          <p>: {updateView.command} </p>
        </div>
